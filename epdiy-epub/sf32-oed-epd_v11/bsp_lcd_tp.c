...
void BSP_LCD_PowerDown(void)
{
    ...
    HAL_PIN_Set(PAD_PA00 + EPD_CLK,    GPIO_A0 + EPD_CLK,    PIN_PULLDOWN, 1);
    HAL_PIN_Set(PAD_PA00 + EPD_SPH,    GPIO_A0 + EPD_SPH,    PIN_PULLDOWN, 1);
    HAL_PIN_Set(PAD_PA00 + EPD_STV,    GPIO_A0 + EPD_STV,    PIN_PULLDOWN, 1);
    HAL_PIN_Set(PAD_PA00 + EPD_CPV,    GPIO_A0 + EPD_CPV,    PIN_PULLDOWN, 1);
    HAL_PIN_Set(PAD_PA00 + EPD_GMODE,    GPIO_A0 + EPD_GMODE,    PIN_PULLDOWN, 1);
